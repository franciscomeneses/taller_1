...
# Terema del limite central


> Es la base teorico-matemática de la estadistica que utilizaremos. No se usa directamente en la práctica, pero justifica nuestras inferencias estadisticas. 

"Si tomamos muchas muestras grandes de cualquier población (sin importar cómo sea su distribución), la distribución de las medias de esas muestras siempre se parecerá a una distribución normal, por lo cual podremos hacer calculos en base a esta distribución" 
